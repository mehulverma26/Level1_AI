...
while True:
    ...
    if query == None:
        ...
        print(
            "I am FRIDAY an AI assistent created by Mehul Verma. I am still not complete but my creator tried hard to create me!"
        )
        speak(
            "I am FRIDAY an AI assistent created by Mehul Verma ... I am still not complete ... but my creator tried hard to create me!"
        )
        ...
        print(
            '"You should be ashamed of yourselves," said the teacher, "When I was your age I did not even know what a lie was."'
        )
        ...
        "open PowerPoint" in query
        or "open microsoft powerpoint" in query
        or "powerpoint" in query
    ):
        powerpoint = (
        ...
        or "WhatsApp" in query
        or "web Whatsapp" in query
    ):
        webbrowser.open("https://web.whatsapp.com/")
    elif (
        "exit" in query.lower().split()
        or "bye" in query.lower().split()
        or "sleep" in query.lower().split()
        or "close" in query.lower().split()
    ):
        speak("Ok bye, " + name + ".")
        print(f"Ok bye, {name}")
        break
